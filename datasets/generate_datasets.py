...
PRODUCTS_CATALOG = [
    ...
    },
    {
        ...
        "components": [
            "30mm Driver Units",
            "Dual Noise Canceling Chips",
            "Soft Fit Leather Earpads",
            "30-hour Battery",
    ...
    },
    {
        ...
        "components": [
            ...
            "HEPA Filtration Cylinder",
            "7-cell Click-in Battery",
            "Cyclonic Dust Bin",
        ],
    ...
    },
    {
        ...
        "components": [
            "65-inch Self-lit OLED Panel",
            "alpha9 AI Processor Gen6 Board",
            "40W 2.2 Ch Speaker Array",
            "Power Supply Unit",
            "Magical Remote Sensor",
        ],
    ...
    },
    {
        ...
        "components": [
            "7-inch OLED Display",
            "Tegra X1 System Board",
            "Joy-Con Rail Controls",
            "4310mAh Battery",
            "Docking Station Mainboard",
        ],
    ...
    },
    {
        ...
        "components": [
            ...
            "VarioDrum Stainless Tub",
            "AquaStop Safety Valve",
            "Digital Touch Control Board",
            "Heavy Weight Ballast Block",
        ],
    ...
    },
    {
        ...
        "components": [
            ...
            "DIGIC X Image Processor Board",
            "5-axis In-Body Stabilizer",
            "EVF Display Module",
...
FAILURE_ISSUES = [
    ...
    "Screen Flicker / Dead Pixels",
    "Thermal Throttling / Overheating",
    "Logic Board Power Failure",
    "Noisy Motor / Bearing Friction",
    "Camera Sensor Artifacts",
    "Wireless Connectivity Loss",
    "Physical Port Corruption",
    "Drifting Analog Stick",
    "Water Seal Compromise",
]

RESOLUTIONS = [
    "Battery Replacement",
    "Screen Assembly Swapped",
    "Refurbished Board Soldered",
    "Unit Replaced Under Warranty",
    "Component Cleaned & Re-calibrated",
    "Claim Rejected - User Damage",
]
...
def generate_marketplace_listings(total_listings=50000):
    ...
    for i in range(1, total_listings + 1):
        ...
        rating = (
            ...
            if marketplace != "OLX"
            else round(random.uniform(2.0, 4.8), 2)
        )
